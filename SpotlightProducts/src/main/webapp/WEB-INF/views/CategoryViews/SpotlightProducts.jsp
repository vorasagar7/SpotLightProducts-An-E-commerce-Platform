...
<ul class="nav nav-pills">
	...
	<li role="presentation"><a href="/filterByShoes"><b>Shoes</b></a></li>
	...
	<li role="presentation" class="active"><a
		href="/filterBySpotlightProducts"><b>SpotLightProducts</b></a></li>
</ul>
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-3">
			<p class="lead">Filter SpotlightProducts</p>

			<div class="list-group">
				<form action="/sortBySpotlightProductsPriceAsc">
					<button type="submit"
						class="list-group-item list-group-item-action">Price Low
						to High</button>
				</form>
				<form action="/sortBySpotlightProductsPriceDesc">
					<button type="submit"
						class="list-group-item list-group-item-action">Price High
						to Low</button>
				</form>
				<form action="/sortBySpotlightProductsNameAsc">
					<button type="submit"
						class="list-group-item list-group-item-action">A to Z</button>
				</form>
				<form action="/sortBySpotlightProductsNameDesc">
					<button type="submit"
		...
		<h1 align="center">Spotlight Products</h1>
