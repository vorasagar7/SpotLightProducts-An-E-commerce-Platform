...
<ul class="nav nav-pills">
	...
	<li role="presentation" class="active"><a
		href="/filterByElectronics"><b>Electronics</b></a></li>
...
<div class="container">
	<div class="row">
		<div class="col-md-3">
			<p class="lead">Filter Electronics</p>
			<div class="list-group">
				<form action="/sortByElectronicsPriceAsc">
					<button type="submit"
						class="list-group-item list-group-item-action">Price Low
						to High</button>
				</form>
				<form action="/sortByElectronicsPriceDesc">
					<button type="submit"
						class="list-group-item list-group-item-action">Price High
						to Low</button>
				</form>
				<form action="/sortByElectronicsNameAsc">
					<button type="submit"
						class="list-group-item list-group-item-action">A to Z</button>
				</form>
				<form action="/sortByElectronicsNameDesc">
					<button type="submit"
