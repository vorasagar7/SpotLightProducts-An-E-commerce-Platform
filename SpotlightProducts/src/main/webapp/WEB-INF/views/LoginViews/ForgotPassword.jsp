					...
					<div class="col-xs-offset-1 col-xs-8 col-md-offset-1 col-md-10">
						...
						<form name="forgotPasswordForm" class="css-form" novalidate>
							...
							<div class="form-group"
								ng-class="{ 'has-error' : forgotPasswordForm.email.$invalid && !forgotPasswordForm.email.$pristine }">
								<label for="InputEmail" class="control-label">Enter Your
									Email address</label> <input name="email" type="email"
									class="form-control" id="InputEmail" placeholder="Email"
									ng-model="forgotPassword.email" required>
								<p
									ng-show="forgotPasswordForm.email.$invalid && !forgotPasswordForm.email.$pristine"
									class="help-block">Enter a valid email.</p>
							</div>
							<div class="form-group">
								<button type="submit" class="btn btn-primary"
									ng-disabled="forgotPasswordForm.$invalid"
									ng-click="sendUserPassword()">
