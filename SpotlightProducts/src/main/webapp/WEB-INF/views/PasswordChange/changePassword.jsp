					...
					<div class="col-xs-offset-1 col-xs-10 col-md-offset-1 col-md-10">
						...
						<form novalidate class="css-form row" name="changePasswordForm">
							...
							<div class="form-group" ng-class="{ 'has-error' : changePasswordForm.oldPassword.$invalid && !changePasswordForm.oldPassword.$pristine }">
								...
								<input name="oldPassword" type="password" class="form-control" id="oldPassword" placeholder="Old Password" ng-model="User.oldPassword" required>
							...
							<div class="form-group" ng-class="{ 'has-error' : changePasswordForm.password.$invalid && !changePasswordForm.password.$pristine }">
								...
								<input name="password" type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" ng-model="User.password" required>
							...
							<div class="form-group" ng-class="{ 'has-error' : User.password !== User.RetypePassword && !changePasswordForm.retypePassword.$pristine }">
								...
								<p ng-show="User.password !== User.RetypePassword && !changePasswordForm.retypePassword.$pristine" class="help-block">Does not match with Password.</p>
							</div>
							<div class="form-group col-xs-offset-4 col-xs-4 col-md-offset-2 col-md-8">
								<button class="btn btn-primary login-button" ng-disabled="changePasswordForm.$invalid || User.password !== User.RetypePassword" ng-click="ChangeUserPassword()">Change Password</button>
							</div>
						</form>
